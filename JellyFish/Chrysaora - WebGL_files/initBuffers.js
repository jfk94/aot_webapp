...
function initBuffers(){
  loadObject('jellyfish0',jellyfish0);
  loadObject('jellyfish1',jellyfish1);
  loadObject('jellyfish2',jellyfish2);
  loadObject('jellyfish3',jellyfish3);
}


function loadObject(name, data){
  initBuffer(name, JSON.parse(data));
  bufferOK[name] = 1;
}
